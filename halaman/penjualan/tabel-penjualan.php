            ...
            <div class="card-body">
                ...
                <table id="tabel-data" class="table dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        $harga_beli = 0;
                        $harga_jual = 0;
                        $query = mysqli_query($conn, "SELECT * FROM v_keranjang WHERE kode_penjualan = '$_POST[kode_penjualan]'");
    ...
    $(document).ready(function () {
        ...
        $('#tabel-data').on('click', '#delete', function () {
            ...
            alertify.confirm('Hapus', 'Apakah anda yakin ingin menghapus transaksi ini? ', function () {
                $.ajax({
                    type: 'POST',
                    url: 'halaman/penjualan/proses-penjualan.php?aksi=hapus-keranjang',
                    data: {
                        id: id
                    },
        ...
        $("#tambah-penjualan").submit(function (e) {
            ...
            if (bayar < total) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'halaman/penjualan/proses-penjualan.php?aksi=tambah-penjualan',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
